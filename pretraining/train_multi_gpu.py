...
def parse_arguments():
    ...
    parser.add_argument("--train_path", default="../data/babycosmofine_10M.jsonl", type=Path, help="Path to the training data.")
    parser.add_argument("--valid_path", default="../data/babycosmofine_10M.jsonl", type=Path, help="Path to the validation data.")
    ...
    parser.add_argument("--global_batch_size", default=32768//4, type=int, help="Total batch size for training per GPUs and per grad accumulation step.")
    ...
    parser.add_argument("--max_steps", default=31250 // 8**2, type=int, help="Total number of training steps to perform.")
